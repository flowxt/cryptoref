...
<li>Crypto-Monnaies : {" "}
    ...
    <li>
        Marchés : {" "}
        {headerData.markets && headerData.markets}
    </li>
            </ul>
            <ul className="infos-mkt">
                ...
                <li>BTC Dominance : {" "}
                {headerData.market_cap_percentage && headerData.market_cap_percentage.btc && headerData.market_cap_percentage.btc.toFixed(1) + "%"}
            </li>
            <li>ETH Dominance : {" "}
                {headerData.market_cap_percentage && headerData.market_cap_percentage.eth && headerData.market_cap_percentage.eth.toFixed(1) + "%"}
            </li>
            </ul>
            <TableFilters />
        </div>
